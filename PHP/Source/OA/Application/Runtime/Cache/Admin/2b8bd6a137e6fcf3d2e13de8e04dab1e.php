	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="name"><?php echo (msubstr($vol["title"],0,8,'utf-8',true)); ?></td>
                    <td class="file"><?php echo ($vol["filename"]); if(!empty($vol["filename"])): ?>【<a href='/OA/index.php/Admin/Doc/download/id/<?php echo ($vol["id"]); ?>'>下载</a>】<?php endif; ?></td>
                    <td class="content"><?php echo ($vol["author"]); ?></td>
                    <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
                    <td class="operate">
                        <a href ='javascript:;' class='show' data='<?php echo ($vol["id"]); ?>'>查看</a> | 
...
<script type="text/javascript" src="/OA/Application/Public/Admin/plugin/layer/layer/layer.js"></script>
...
$(function() {
    $('.show').on('click',function() {
        ...
        layer.open({
          ...
          content: '/OA/index.php/Admin/Doc/lookcontent/id/' + id
        });
    });
});
