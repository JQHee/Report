...
<link rel="stylesheet" href="/OA/Application/Public/Admin/css/info-reg.css" />
<title>移动办公自动化系统</title>
<style type='text/css'>
	select {
		background: rgba(0, 0, 0, 0) url("/OA/Application/Public/Admin/images/inputbg.png") repeat-x scroll 0 0;
...
<script type="text/javascript" charset="utf-8" src="/OA/Application/Public/Admin/plugin/ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/OA/Application/Public/Admin/plugin/ueditor/ueditor.all.min.js"> </script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8" src="/OA/Application/Public/Admin/plugin/ueditor/lang/zh-cn/zh-cn.js"></script>
