...
<head>
	...
	<link rel="stylesheet" href="/oa/Application/Public/Admin/css/login.css" />
			...
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        <cite><img style="margin-left: 3px" src="/oa/index.php/Admin/Public/captcha" onClick="this.src='/oa/index.php/Admin/Public/captcha/t/' + Math.random()"/></cite>
                    </p>
                </div>
