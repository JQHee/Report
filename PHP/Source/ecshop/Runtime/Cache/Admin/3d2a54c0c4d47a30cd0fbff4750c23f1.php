                    ...
                    <form action="#" method="post">
                        <ul>
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="/ecshop/index.php/Admin/Manager/verifyImg"  
                                                 onClick = "this.src = '/ecshop/index.php/Admin/Manager/verifyImg/' + Math.random()"
                                                 alt="" />
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url('<?php echo ADMIN_IMAGE_URL?>user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
